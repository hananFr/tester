...
- מאפס שוב את `weapons.json` לפני כל בדיקת אנדפוינט, כדי שכל בקשה תיבדק מול דאטה נקי.
...
כל ניקוד האנדפוינטים ניתן על קלט תקין בלבד. אין חלוקת נקודות בתוך האנדפוינט על טיפול בשגיאות או על קלט לא תקין.

שימוש ב־`HTTPException` נבדק כסעיף גלובלי אחד של `5` נקודות בתוך הניקוד האוטומטי הנוסף, ולא כחלק מה־`9` נקודות של כל אנדפוינט.
